...
LYSimProtonGeneratorAction::LYSimProtonGeneratorAction() : particleSource(new G4GeneralParticleSource()),
...
void LYSimProtonGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
...
void LYSimProtonGeneratorMessenger::SetNewValue(G4UIcommand *command, G4String val)
{
