...
void
LYSimTrajectory::ShowTrajectory( std::ostream& os ) const
{
...
void
LYSimTrajectory::DrawTrajectory() const
{
  // Invoke the default implementation in G4VTrajectory...
...
void
LYSimTrajectory::DrawTrajectory( G4int i_mode ) const
{
  // Invoke the default implementation in G4VTrajectory...
...
void
LYSimTrajectory::AppendStep( const G4Step* aStep )
{
  fpPointsContainer->push_back( new LYSimTrajectoryPoint( aStep ) );
}

G4ParticleDefinition*
LYSimTrajectory::GetParticleDefinition()
{
  return G4ParticleTable::GetParticleTable()->FindParticle( ParticleName );
}

void
LYSimTrajectory::MergeTrajectory( G4VTrajectory* secondTrajectory )
{
...
LYSimTrajectory::GetAttDefs() const
{
  G4bool isNew;
...
LYSimTrajectory::CreateAttValues() const
{
