...
=======
  ...
  _sipm_x = 10 * mm;
  _sipm_y = 10 * mm;
>>>>>>> parent of abd9d85 (Merge pull request #3 from yihui-lai/jun2)
...
=======
  ...
  else
  {
    ...
    G4LogicalSkinSurface *WrapfaceSurface = new G4LogicalSkinSurface("WrapfaceSurface", logicWrapface, MakeS_VAbsorbing()); // define surface at end 
