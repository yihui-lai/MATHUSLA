...
LYSimDetectorConstruction::Construct()
{
  ...
  if (_holeshape == 0)
    ...
    solidHoleBound = new G4EllipticalTube("TileHole", _hole_radius, 2, _tilez);
...
*/
  ...
  if (_holeshape == 0)
    ...
    solidHole = new G4EllipticalTube("TileHole", _hole_radius, 2, _tilez * 0.5);
